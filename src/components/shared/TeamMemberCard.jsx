  ...
  return (
    <>
      ...
      <div
        ...
        className="flex flex-col relative min-h-[22rem] rounded-[1.26rem] grow min-[670px]:grow-0 cursor-pointer transition-all -translate-y-0 shadow-none duration-300 hover:-translate-y-3 hover:shadow-lg"
      >
        {/* width default: w-[clamp(268px,calc(100%/4),18rem)] */}
        <div className="h-full w-full rounded-[1rem] overflow-hidden">
          <img
            loading="lazy"
            src={data.image}
        ...
        <div className="flex-1 absolute -bottom-6 left-0 w-[80%] bg-white flex flex-col border-t-transparent rounded-tr-[1rem]">
          <p className="mt-6 line-clamp-1 font-medium text-xl font-inter text-[#333333] pl-5">
            {data.name}
          </p>
          <p className="mt-3 line-clamp-1 font-medium text-sm font-plusJakartaSans text-[#666666] pl-5">
            {data.role}
          </p>
